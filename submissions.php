    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href='submissions.php'>Submissions</a></li>
  ...
  <main id="main">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <br>
                <h3 class="section-title">Paper Submission</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
              <p>Registering as a presenter in the main conference, the participants can present their original research findings and best practices either in oral or poster sessions, while review article can be included only in an oral session. While participation in oral session is requiring the authors to submit the Full Paper (.doc format only), those who decide to participate in Poster session may send ONLY the ABSTRACT (.doc format only). Refer to the Important Dates to see the last day to proceed the submission. Selected papers submitted only from the 1st Round.
              </p>
